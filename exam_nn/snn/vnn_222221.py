...
if __name__ == "__main__":
    ...
    layers = {} 
    layers[1] = NeuronLayer(2, 3)   #the first layer -- 4 neurons 3 inputs
    layers[2] = NeuronLayer(2, 2)
    layers[3] = NeuronLayer(2, 2) 
    layers[4] = NeuronLayer(2, 2) 
    layers[5] = NeuronLayer(2, 2) 
    layers[6] = NeuronLayer(1, 2)   #the last one layer -- the output, 1 neourons, 6 inputs  
