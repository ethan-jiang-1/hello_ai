...
if __name__ == "__main__":
    ...
    layers = {} 
    layers[1] = NeuronLayer(3, 3)   #the first layer -- 4 neurons 3 inputs
    layers[2] = NeuronLayer(3, 3)
    layers[3] = NeuronLayer(3, 3) 
    layers[4] = NeuronLayer(3, 3) 
    layers[5] = NeuronLayer(1, 3)   #the last one layer -- the output, 1 neourons, 6 inputs  
