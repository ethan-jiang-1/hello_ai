...
if __name__ == "__main__":
    ...
    layers[2] = NeuronLayer(5, 4)
    layers[3] = NeuronLayer(6, 5) 
    layers[4] = NeuronLayer(5, 6) 
    layers[5] = NeuronLayer(4, 5) 
    layers[6] = NeuronLayer(1, 4)   #the last one layer -- the output, 1 neourons, 6 inputs  
